...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _views_bank__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./views/bank */ "./src/scripts/views/bank.js");
...
var Main = function Main() {
  ...
  new _views_bank__WEBPACK_IMPORTED_MODULE_0__["default"]();
};
  ...
  _createClass(Bank, [{
    ...
    value: function initScript() {
      ...
      window.vm = new vue_dist_vue_common__WEBPACK_IMPORTED_MODULE_0___default.a({
        ...
        data: {
          button: (_button = {}, _defineProperty(_button, "depositar", {
            name: "DEPOSITAR",
            icon: "fas fa-share"
          }), _defineProperty(_button, "sacar", {
            name: "SACAR",
            icon: "fas fa-reply"
          }), _defineProperty(_button, "transferir", {
            name: "TRANSFERIR",
            icon: "fas fa-history"
          }), _button),
          timeLine: [{
            type: "deposit",
            subtitle: "Av. Strawberry - ATM #2",
            value: 6000.22
          }, {
            type: "withdraw",
            subtitle: "Av. Orange - ATM #84",
            value: 3005.41
          }, {
            type: "transfer",
            subtitle: "Transfered to player 3",
            value: 7007.62
          }],
          selectedButton: null,
          showBank: false
        ...
        methods: {
          createTimeLine: function createTimeLine() {
            for (var _i = 0, _Object$entries = Object.entries(this.timeLine); _i < _Object$entries.length; _i++) {
              var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
                  pairs = _Object$entries$_i[0],
                  contains = _Object$entries$_i[1];

              if (contains.type == 'deposit') {
                this.timeLine[pairs].icon = "fas fa-share";
                this.timeLine[pairs].name = "DEPOSITO";
              } else if (contains.type == 'withdraw') {
                this.timeLine[pairs].icon = "fas fa-reply";
                this.timeLine[pairs].name = "SAQUE";
              } else if (contains.type == 'transfer') {
                this.timeLine[pairs].icon = "fas fa-history";
                this.timeLine[pairs].name = "TRANSFERENCIA";
              }
            }

            return this.timeLine;
          },
          clickButton: function clickButton(self, form) {
            this.selectedButton = form;

            for (var _i2 = 0, _Object$entries2 = Object.entries(this.button); _i2 < _Object$entries2.length; _i2++) {
              var _Object$entries2$_i = _slicedToArray(_Object$entries2[_i2], 2),
                  name = _Object$entries2$_i[0],
                  pairs = _Object$entries2$_i[1];
...
$(document).ready(function () {
  $(document).keydown(function (event) {
    if (event.which == 27 || event.which == 71) {
      window.vm.showBank = false;
      $.post("http://_banking/_bankClose");
    }
  });
...
module.exports = __webpack_require__(/*! C:\Users\Gabriel\Desktop\UI\Bank\src\scripts\main.js */"./src/scripts/main.js");
