...
Config.Languages = {
  ['en'] = {
        ...
        ['sentrequestto'] = "Solicitação enviada para ~y~",
        ['nobodyclose'] = "Ninguem por perto.",
        ['doyouwanna'] = "~y~Y~w~ para aceitar, ~r~L~w~ para recusar (~g~",
        ['refuseemote'] = "Solicitação recusada.",
        ['makenearby'] = "makes the nearby player play",
        ['camera'] = "Aperte ~y~G~w~ para usar o flash.",
        ['makeitrain'] = "Aperte ~y~G~w~ para jogar dinheiro.",
        ['pee'] = "Aperte ~y~G~w~ para fazer xixi.",
        ['spraychamp'] = "Aperte ~y~G~w~ para estourar o champagne",
        ['bound'] = "Bound ",
        ['to'] = "to",
