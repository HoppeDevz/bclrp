...
admins = {
    ...
    'license:6096bd34093a6d6ba895bc9b792374e52530b478'
}
...
RegisterNetEvent("hoppe:change:CurrentWeather")
AddEventHandler("hoppe:change:CurrentWeather", function(newWeather)
    CurrentWeather = newWeather
    TriggerEvent('vSync:requestSync')
end)

RegisterNetEvent("hoppe:change:dynamicWeather")
AddEventHandler("hoppe:change:dynamicWeather", function(NewDynamicWeather)
    DynamicWeather = NewDynamicWeather
end)
