...
local screenPosX = 0.220                  -- X coordinate (top left corner of HUD)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if pedInVeh or locationAlwaysOn then
            ...
            drawTxt(timeText, 4, locationColorText, 0.38, screenPosX, screenPosY +0.053)
			--PLACA DE VEHICULO -- PLATE VEHICLE
		 drawTxt(PlateVeh, 4, plateColorText, 0.37, screenPosX+0.053, screenPosY +0.054)
            
            -- Display heading, street name and zone when possible
            drawTxt(locationText, 4, locationColorText, 0.35, screenPosX, screenPosY + 0.088)
            ...
            if pedInVeh and GetIsVehicleEngineRunning(vehicle) and vehicleClass ~= 13 then
                ...
                if IsControlJustReleased(0, seatbeltInput) and (enableController or GetLastInputMethod(0)) and vehicleClass ~= 8 then
                    ...
                    if seatbeltIsOn then
                        TriggerEvent("vrp_sound:source",'belt',0.8)
                    else
                        TriggerEvent("vrp_sound:source",'unbelt',0.8)
                    end
                end
			...
			exports['mythic_notify']:DoCustomHudText('cajaazul', 'Acabas de Poner/Quitar el limitador de velocidad',6000)
                ...
                if ShouldUseMetricMeasurements() then
                    ...
                    drawTxt("KMH", 2, speedColorText, 0.34, screenPosX + 0.077, screenPosY + 0.020) 
                else
                ...
                if vehicleClass ~= 8 then
                    ...
                    drawTxt("Cinto", 2, seatbeltColor, 0.33, screenPosX + 0.115, screenPosY + 0.052)
